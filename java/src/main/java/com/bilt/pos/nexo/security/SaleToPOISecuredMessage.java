 ...
 *
 * <p>The original JSON payload is AES-encrypted into the {@link EnvelopedData} (with a per-message
 * session key wrapped by the KEK), the unencrypted {@link MessageHeader} is preserved for routing,
 * and a {@link ContentInformationType} security trailer carries the HMAC for integrity
 * verification.
 */
