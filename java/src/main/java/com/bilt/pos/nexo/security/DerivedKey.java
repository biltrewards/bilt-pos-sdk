 ...
 *
 * <p>The 80 bytes produced by PBKDF2 are split into:
 *
 * <ul>
 *   <li>32-byte HMAC key (HmacSHA256)
 *   <li>32-byte cipher key (AES-256)
 *   <li>16-byte initialization vector (XORed with a per-message nonce)
 * </ul>
 */
final class DerivedKey {
  ...
  static DerivedKey derive(String passphrase) throws EncryptionException {
    try {
      ...
      PBEKeySpec spec = new PBEKeySpec(passphrase.toCharArray(), salt, iterations, totalLength * 8);
