...
/**
 * A payment collected and owned by the register rather than the terminal. Settlement accepts it
 * only as a replacement for a failed final card tender, and its amount must exactly equal the
 * outstanding balance.
 */
