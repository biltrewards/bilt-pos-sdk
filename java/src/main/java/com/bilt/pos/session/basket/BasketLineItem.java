 ...
 *
 * <p>{@code rebateAmount} and {@code rebateLabel} are zero/{@code null} while the cart is being
 * built; they are populated on the baskets delivered during payment orchestration, after the
 * terminal commits offers.
 *
 * <p>On a return or credit line the totals — {@code originalTotal}, {@code adjustedTotal}, and
 * {@code taxAmount} — are negative; quantity and unit price stay positive counts and catalog
 * prices.
 */
