...
/**
 * Extracts session {@link Receipt}s from Nexo {@code PaymentReceipt} arrays. Best-effort: an
 * unparsable receipt payload yields {@code null} and a WARN log rather than failing the transaction
 * that produced it.
 */
