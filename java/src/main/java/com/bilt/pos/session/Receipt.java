 ...
 *
 * <p>Thin, decoded view over the SDK's {@link ReceiptType} ({@code receipt.xsd}, {@code
 * urn:bilt:receipt:v1}) as carried Base64-encoded in Nexo {@code PaymentReceipt} content.
 */
public final class Receipt {
  ...
  /**
   * Builds a {@code Receipt} from a Base64-encoded receipt XML payload, as found in {@code
  ...
  /**
   * Structured receipt fields — merchant identity, amounts, card data, and EMV tags — or {@code
   * null} if not present.
   */
