 ...
 *
 * <p>Create with {@link #text(String)} for plain text or {@link #xhtml(String)} for a
 * Base64-encoded XHTML document, optionally changing the document kind with {@link
 * #withDocumentQualifier}.
 */
