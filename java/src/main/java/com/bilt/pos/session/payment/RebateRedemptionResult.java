...
/**
 * Result of the rebate step, delivered to {@code onRebatesRedeemed}. The handler returns the total
 * for the next step — typically {@link #getSuggestedTotal()}, adjusted when tax must be recomputed
