 ...
 *
 * <p>Indices are zero-based positions into the entry list passed to {@code requestMenuEntry}. For
 * single-select menus {@link #getIndex()} and {@link #getValue()} carry the selection; the list
 * accessors always contain every selected entry.
 */
