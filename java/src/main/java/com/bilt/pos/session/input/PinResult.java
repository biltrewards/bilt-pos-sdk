 ...
 *
 * <p>For {@link PinMode#PIN_ENTER} and {@link PinMode#PIN_VERIFY} the encrypted PIN block is
 * carried in the {@link CardholderPIN} structure (a CMS envelope, never a raw PIN).
 */
