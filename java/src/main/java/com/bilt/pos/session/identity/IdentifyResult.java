 ...
 *
 * <p>Member data ({@code memberId}, {@code rewards}, {@code pointBalance}) is populated only when
 * {@link #getStatus()} is {@link IdentifyStatus#FOUND}; the other statuses describe why no member
 * is attached (not found, suspended, cancelled on the terminal).
 */
