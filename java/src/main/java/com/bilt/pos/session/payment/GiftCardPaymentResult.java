...
/**
 * Result of the stored value step, delivered to {@code onGiftCardPayment}. The handler returns the
 * total for the next step — typically {@link #getSuggestedTotal()}. When the card balance was
 * insufficient, the charge is a partial authorization and {@code suggestedTotal} carries the
...
public final class GiftCardPaymentResult {
  ...
  public GiftCardPaymentResult(
      BigDecimal amountCharged,
      BigDecimal remainingCardBalance,
