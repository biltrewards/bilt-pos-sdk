...
public final class StoredValueLoadRecord {
  ...
  private StoredValueLoadRecord(Builder builder) {
    this.basketReference = Objects.requireNonNull(builder.basketReference, "basketReference");
    this.amount = Objects.requireNonNull(builder.amount, "amount");
    this.poiTransactionId = Objects.requireNonNull(builder.poiTransactionId, "poiTransactionId");
  ...
  public int hashCode() {
    return Objects.hash(
        basketReference, amount.stripTrailingZeros(), poiTransactionId, poiTransactionTimestamp);
  }
