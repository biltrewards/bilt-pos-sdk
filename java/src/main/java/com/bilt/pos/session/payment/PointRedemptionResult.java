...
/**
 * Result of the point/reward redemption step, delivered to {@code onPointsRedeemed}. The handler
 * returns the total for the next step — typically {@link #getSuggestedTotal()}.
 */
