 ...
 *
 * <p>Derived from the transport outcome and the Nexo {@code Response.ErrorCondition} of the
 * terminal reply; the raw condition is preserved on {@link SessionError#getNexoErrorCondition()}.
 */
