...
/**
 * Unchecked exception thrown when a failed session operation is unwrapped via {@link
 * SessionResult#get()}.
 *
 * <p>Callers that registered an {@code onError} handler and use {@code execute()} or {@code
 * getOrNull()} never see this exception.
 */
