...
/**
 * Fixed catalog spanning sub-dollar items to $500+, so every price band of the payment flow
 * (small-ticket, signature thresholds, large amounts) is one tap away. Replace with a real provider
 * when the emulator grows one.
 */
