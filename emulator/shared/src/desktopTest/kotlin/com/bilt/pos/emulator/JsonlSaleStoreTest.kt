...
class JsonlSaleStoreTest {
    ...
    private fun sale(id: String, legs: List<TransactionLeg> = emptyList()) =
        SaleRecord(
            id = id,
    ...
    fun refundsAndVoidFoldIntoTheSale() {
        ...
        store.recordRefund(
            ...
            RefundRecord(
                amount = "0.50",
                poiTransactionId = "poi-r2",
                recordedAt = "2026-08-04T11:05:00Z",
            ),
        )
        store.recordVoid(
            "s2",
            VoidRecord(
                poiTransactionId = "poi-v1",
                recordedAt = "2026-08-04T11:10:00Z",
            ),
        )
